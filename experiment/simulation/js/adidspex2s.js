...
var b1 = document.getElementById('b1'),
    ...
    b4 = document.getElementById('b4');// fourth block added in the exp2
...
b24 = new LeaderLine(b2, LeaderLine.pointAnchor(b4, {x: '0%', y: '50%'}),
...
b43 = new LeaderLine(b4, LeaderLine.pointAnchor(b3, {x: '0%', y: '80%'}),
  ...
  new PlainDraggable(b2, {
    ...
    ckt=0,
    plt(0),
    b12.position(),b23.position(),b24.position(); }
    });
  ...
  new PlainDraggable(b3, {
    ...
    ckt=0,
    plt(0),
    b13.position(),b23.position(),b24.position(),b43.position(); }
    });
